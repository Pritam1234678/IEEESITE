    ...
    <div className="flex justify-center items-center p-4">
      ...
      >
          ...
          <motion.div
            ...
            animate={{
              borderColor: isHovered 
                ? ["rgba(255, 107, 107, 0.8)", "rgba(238, 90, 36, 0.8)", "rgba(255, 107, 107, 0.8)"]
                : "transparent",
              boxShadow: isHovered
        ...
        <motion.div
          ...
          animate={{
            borderColor: isHovered 
              ? ["rgba(147, 51, 234, 0.8)", "rgba(59, 130, 246, 0.8)", "rgba(147, 51, 234, 0.8)"]
        ...
        >
          <h3 className="text-white text-xl font-bold mb-2 drop-shadow-lg">
            {isHovered ? "Second Image Revealed!" : "Hover to Reveal"}
          </h3>
          <p className="text-white/90 text-sm drop-shadow-md">
            Smooth 3-second GSAP overlay animation ✨
          </p>
        </motion.div>
