  ...
  return (
    <div className="flex justify-center items-center p-4">
      ...
      >
        ...
        {/* First Image - Background Layer (p5.jpg) */}
        <motion.div
        ...
        {/* Second Image - Overlay Layer (p6.jpg) appears from center */}
        <div
          ref={secondImageRef}
          ...
          <motion.div
            ...
            animate={{
              borderColor: isHovered 
                ? ["rgba(236, 72, 153, 0.8)", "rgba(219, 39, 119, 0.8)", "rgba(236, 72, 153, 0.8)"]
                : "transparent",
              boxShadow: isHovered
                ? "0 0 30px rgba(236, 72, 153, 0.6), inset 0 0 20px rgba(219, 39, 119, 0.3)"
                : "none"
            }}
            transition={{ 
              duration: 2,
